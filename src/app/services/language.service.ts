...
const translations = {
  en: {
    ...
    viewMatchReason: 'View match reason',
    showLess: 'Show less',
    viewFullProfile: 'View full profile',
    passed: 'Passed ✓',
    notInterested: 'Not interested',
    feedbackActionLimit: 'You can change your Not interested choice up to 5 times.',
  ...
  he: {
    ...
    viewMatchReason: 'הצג סיבת התאמה',
    showLess: 'הצג פחות',
    viewFullProfile: 'הצג פרופיל מלא',
    passed: 'לא מתאים ✓',
    notInterested: 'לא מעוניין',
    feedbackActionLimit: 'אפשר לשנות את בחירת "לא מעוניין" עד 5 פעמים.',
